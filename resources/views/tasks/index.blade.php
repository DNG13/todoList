                    ...
                    <div class="content-grid">
                        <h1>What is to be done?
                            <div class="btn-group">
                                ...
                                <a href="/tasks/show" title="Old Tasks" class="btn btn-primary btn-sm">
                                    <i aria-hidden="true" class="fa fa-archive"></i> Archive
                                </a>
                            </div>
                        </h1>
                        <hr>
                        @forelse ($tasks as $key=>$item)
                            ...
                            <div class="content-grid-info col-lg-8 col-lg-offset-4">
                                <h4>Date: {{  date(" D, j M Y  H:i", strtotime($task->date)) }}<div class="btn-group">
